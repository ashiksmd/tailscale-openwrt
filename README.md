...
- `.github/workflows/release-upstream-build.yml` runs when `upstream-version.txt` changes, rebuilds the release artifacts, and creates a GitHub release tagged with that version.
